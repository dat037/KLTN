...
\begin{table}[H]
    \centering
    \caption{Kết quả kiểm định độ phù hợp dựa trên sai số bình phương trung bình}
    \vspace{0.2cm}
    \begin{tabular}{|l|c|c|}
        \hline
        \textbf{Mô hình Copula} & \textbf{Sai số toàn phương trung bình (MSE)} & \textbf{Xếp hạng} \\
        \hline
        Gaussian Copula & 0.1452 & 2 \\ % Gắn số Gaussian vào đây
        t-Student Copula (df=4) & 0.0891 & \textbf{1} \\ % Gắn số t-Student vào đây
        Clayton Copula & 0.2105 & 3 \\ % Gắn số Clayton vào đây
        \hline
    \end{tabular}
