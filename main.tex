...
\subsection{Lý thuyết Copula}
\subsubsection{Định lý Sklar}
\subsubsection{Các loại mô hình}
\subsection{Ứng dụng mô phỏng Monte Carlo từ Copula}
%PHẦN 3: PHƯƠNG PHÁP NGHIÊN CỨU
\section{PHƯƠNG PHÁP NGHIÊN CỨU}
\subsection{Thu thập và xử lý dữ liệu}
\subsection{Quy trình phân tích dữ liệu}

%PHẦN 4: PHÂN TÍCH MÔ PHỎNG VÀ KẾT QUẢ
...
%PHẦN 5: THẢO LUẬN VÀ HÀM Ý QUẢN TRỊ
...
%PHẦN 6: KẾT LUẬN VÀ HƯỚNG NGHIÊN CỨU TƯƠNG LAI
