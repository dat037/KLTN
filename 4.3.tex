\begin{itemize}
    ...
    \item Để loại bỏ xu hướng thời gian và đảm bảo tính dừng của chuỗi dữ liệu, giá đóng cửa của các cổ phiếu được chuyển đổi sang chuỗi tỷ suất sinh lợi logarit hàng ngày. Tỷ suất sinh lợi $R_{i,t}$ được xác định bằng công thức:
    \bea 
    R_{i,t} = \ln\left(\frac{P_{i,t}}{P_{i,t-1}}\right) ,
    \eea
    trong đó $P_{i,t}$ và $P_{i,t-1}$ lần lượt là giá đóng cửa của cổ phiếu $i$ tại ngày giao dịch $t$ và $t-1$.
\end{itemize}
\cite{black1973pricing}